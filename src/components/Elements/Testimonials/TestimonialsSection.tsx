						...
						>
							<SwiperSlide>
								<div className="ktestimonial mb-30 swiper-slide">
									<div className="ktestimonial-text">
										<p>
											I was very impresed by the kimox service lorem ipsum is
											simply free text used by copy typing refreshing. Neque
											porro est qui dolorem ipsum.
										</p>
									</div>
							...
							<SwiperSlide>
								<div className="ktestimonial mb-30 swiper-slide">
									<div className="ktestimonial-text">
										<p>
											Reliable accessible UI components: :focus styles, content
											sliders, dark mode, date pickers, navigation, modals,
											radio buttons Neque porro est qui.
										</p>
									</div>
									<div className="ktestimonial-author">
										<div className="ktestimonial-author-img">
											<img
												src="assets/img/testimonial/testimonial-img-2.jpg"
												className="img-fluid"
												alt="client-img"
											/>
										</div>
							...
							<SwiperSlide>
								<div className="ktestimonial mb-30 swiper-slide">
									<div className="ktestimonial-text">
										<p>
											Useful CSS tools for animations, border-radius, CSS
											shadows, cubic-bezier curves, easing gradients, filters,
											placeholders, CSS Grid.
										</p>
									</div>
									<div className="ktestimonial-author">
										<div className="ktestimonial-author-img">
							...
							<SwiperSlide>
								<div className="ktestimonial mb-30 swiper-slide">
									...
									<div className="ktestimonial-author">
										<div className="ktestimonial-author-img">
											<img
												src="assets/img/testimonial/testimonial-img-4.jpg"
												className="img-fluid"
												alt="client-img"
											/>
										</div>
							...
							<SwiperSlide>
								<div className="ktestimonial mb-30 swiper-slide">
									<div className="ktestimonial-text">
										<p>
											Core Web Vitals, CrUX, Lighthouse, performance budgets,
											CSS & JavaScript performance, assets optimizations, build
											optimizations.
										</p>
									</div>
									<div className="ktestimonial-author">
										<div className="ktestimonial-author-img">
											<img
												src="assets/img/testimonial/testimonial-img-5.jpg"
												className="img-fluid"
												alt="client-img"
											/>
										</div>

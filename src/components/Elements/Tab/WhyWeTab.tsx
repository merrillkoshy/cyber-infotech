			...
			<div className="why-tabs-content">
				<TabPanel>
					<div className="tab-panes">
						<p className="mb-30">
							Discover which SVG patterns we should avoid and which patterns are
							the most inclusive when comparing different combinations of OSs,
				...
				<TabPanel>
					<div className="tab-panes">
						...
						<div className="why-tab-wrapper">
							<div className="why-tab-img">
								<img
									src="assets/img/about/about-img-8.jpg"
									className="img-fluid"
									alt="about-img"
								/>
							</div>
				...
				<TabPanel>
					<div className="tab-panes">
						<p className="mb-30">
							Mistakes. These cruel villains do not even stop at the beautiful
							world of software development. But although we cannot avoid making
							mistakes, we can learn to undo them!
						</p>
						<div className="why-tab-wrapper">
							<div className="why-tab-img">
								<img
									src="assets/img/about/about-img-9.jpg"
									className="img-fluid"
									alt="about-img"
								/>
							</div>
